"""Exports execution models to JSON, YAML, or a plain dict.
...
class SQLExecutionSerializer:
    """Stateless exporter for any sql_execution Pydantic model (e.g. `SQLExecutionResult`).
    ...
    def to_yaml(model: BaseModel) -> str:
        ...
        return yaml.safe_dump(
            SQLExecutionSerializer.to_dict(model), sort_keys=False, allow_unicode=True
        )
