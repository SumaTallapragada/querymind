...
Wired to run asynchronously against the same :class:`~querymind.core.config.Settings`
and :class:`~querymind.db.base.Base` metadata the application itself uses,
so there is exactly one definition of "what the schema should look like"
and exactly one place the database URL is read from.
"""
